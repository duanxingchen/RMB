...
CREATE TABLE `business_composition_analysis`  (
  ...
  `main_business_rpofit` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主营利润(元)',
  `mbr_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '利润比例',
  `item_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主营构成',
  `mbc_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '成本比例',
  `gross_rpofit_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '毛利率(%)',
  `main_business_cost` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主营成本(元)',
  `security_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `mainop_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '行业类型',
  `mbi_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主营收入比例',
  `rank` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '排名',
  `secucode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `report_date` datetime(0) NULL DEFAULT NULL COMMENT '报告日期',
  `main_business_income` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主营收入(元)',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '主营构成分析' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `commission_detail`  (
  ...
  `tran_id` bigint NOT NULL COMMENT '交易流水号',
  ...
  `sale_order_volume` bigint NULL DEFAULT NULL COMMENT '委卖量,此表中的委托量全为成交的委托量',
  `buy_order_volume` bigint NULL DEFAULT NULL COMMENT '委买量',
...
CREATE TABLE `company_info`  (
  ...
  `issuance` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '发行量',
  `issue_price` double(255, 2) NULL DEFAULT NULL COMMENT '每股发行价',
  `dongcai_industry` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所属东财行业',
  `securities_industry` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所属证监会行业',
  `legal_representative` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '法人代表',
  `chairman` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '董事长',
  `area` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '区域',
  `registered_capital` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '注册资本',
  `employees` int NULL DEFAULT NULL COMMENT '雇员人数',
  `company_profile` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '公司简介',
  `business_scope` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '经营范围',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '数据创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '数据更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `code`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38851 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '股票基本信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `dragon_tiger_department`  (
  ...
  `act_buy` bigint NULL DEFAULT NULL,
  `act_sell` bigint NULL DEFAULT NULL,
  `net_amt` bigint NULL DEFAULT NULL,
...
CREATE TABLE `dragon_tiger_detail`  (
  ...
  `accum_amount` bigint NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for gincomeqc
-- ----------------------------
DROP TABLE IF EXISTS `gincomeqc`;
CREATE TABLE `gincomeqc`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `report_date` datetime(0) NULL DEFAULT NULL COMMENT '报告期',
  `total_operate_income` decimal(20, 0) NULL DEFAULT NULL COMMENT '营业总收入',
  `operate_profit` decimal(20, 2) NULL DEFAULT NULL COMMENT '营业利润',
  `total_operate_cost` decimal(20, 2) NULL DEFAULT NULL COMMENT '营业总成本',
  `operate_cost` decimal(20, 2) NULL DEFAULT NULL COMMENT '营业成本',
  `research_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '研发费用',
  `operate_tax_add` decimal(20, 2) NULL DEFAULT NULL COMMENT '营业税金及附加',
  `sale_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '销售费用',
  `manage_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '管理费用',
  `finance_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '财务费用',
  `fe_interest_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '其中:利息费用',
  `fe_interest_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '其中:利息收入',
  `other_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '其他收益',
  `invest_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '投资收益',
  `fairvalue_change_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '加:公允价值变动收益',
  `credit_impairment_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '信用减值损失(新)',
  `nonbusiness_income` decimal(20, 2) NULL DEFAULT NULL COMMENT '加:营业外收入',
  `nonbusiness_expense` decimal(20, 2) NULL DEFAULT NULL COMMENT '减:营业外支出',
  `total_profit` decimal(20, 2) NULL DEFAULT NULL COMMENT '利润总额',
  `income_tax` decimal(20, 2) NULL DEFAULT NULL COMMENT '减:所得税',
  `netprofit` decimal(20, 2) NULL DEFAULT NULL COMMENT '净利润',
  `continued_netprofit` decimal(20, 2) NULL DEFAULT NULL COMMENT '持续经营净利润',
  `parent_netprofit` decimal(20, 2) NULL DEFAULT NULL COMMENT '归属于母公司股东的净利润',
  `deduct_parent_netprofit` decimal(20, 2) NULL DEFAULT NULL COMMENT '扣除非经常性损益后的净利润',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `un`(`code`, `report_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 472983 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '成长能力' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `guba`  (
  ...
  `num` int NULL DEFAULT NULL COMMENT '人气排名',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `history_capital_flows`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `tran_date` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '日期',
  `main` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主力净流入',
  `small_single` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '小单净流入',
  `medium_singles` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '中单净流入',
  `large_orders` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '大单净流入',
  `single_large_orders` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '超大单净流入',
  `main_rate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '主力净流入占比',
  `small_single_rate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '小单净流入占比',
  `medium_singles_rate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '中单净流入占比',
  `large_orders_rate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '大单净流入占比',
  `single_large_orders_rate` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '超大单净流入占比',
  `closing_price` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收盘价',
  `quote_change` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '涨跌幅',
  `other` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '其他',
  `other_one` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '其他1',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '数据创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '数据更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `code`(`code`, `tran_date`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '历史资金流向' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `holder_num`  (
  ...
  `change_shares` bigint NULL DEFAULT NULL,
  `holder_num` bigint NULL DEFAULT NULL,
  `holder_num_change` bigint NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `report_date` date NULL DEFAULT NULL,
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `pre_holder_num` bigint NULL DEFAULT NULL,
  ...
  `change_reason` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `total_a_shares` bigint NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '数据入库时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '数据更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `un`(`code`, `report_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21329795 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '股东人数' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `industry`  (
  ...
  `up_num` int NULL DEFAULT NULL COMMENT '上涨家数',
  `down_num` int NULL DEFAULT NULL COMMENT '下跌家数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '主要财务指标' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `operating_capacity`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `code`(`code`, `report_date`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '营运能力' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `organization_details_holder`  (
  ...
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票名称',
  `parent_org_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '机构组织代码',
  `org_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '机构类型',
  `org_type_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '机构类型编码',
  `security_inner_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码内部',
  ...
  `total_shares` bigint NULL DEFAULT NULL COMMENT '持股总数',
  `total_shares_ratio` double(16, 2) NULL DEFAULT NULL COMMENT '	占总股本比例(%',
  `report_date` date NULL DEFAULT NULL COMMENT '报告时间',
  `holder_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '机构名称',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '数据创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '数据更新时间',
  `net_asset_ratio` double(16, 2) NULL DEFAULT NULL COMMENT '净资产率',
  `org_name_abbr` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '机构名称',
  `buy_state` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `name`(`name`, `report_date`) USING BTREE,
  INDEX `code`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 302810 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pay_ability`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `code`(`code`, `report_date`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '偿还能力' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `plate_block`  (
  ...
  `plate_num` int NULL DEFAULT NULL,
  `rocket_launch` int NULL DEFAULT NULL,
  `big_buy` int NULL DEFAULT NULL,
  `big_sales` int NULL DEFAULT NULL,
  `rapid_rebound` int NULL DEFAULT NULL,
  `buy_bid` int NULL DEFAULT NULL,
  `sales_bid` int NULL DEFAULT NULL,
  `high_diving` int NULL DEFAULT NULL,
  `day_low_60` int NULL DEFAULT NULL,
  `sharp_rise_60` int NULL DEFAULT NULL,
  `day_high_60` int NULL DEFAULT NULL,
  `sharp_drop_60` int NULL DEFAULT NULL,
  `down_limit` int NULL DEFAULT NULL,
  `high_limit` int NULL DEFAULT NULL,
  `open_down_limit` int NULL DEFAULT NULL,
  `open_high_limit` int NULL DEFAULT NULL,
  `upward_notch` int NULL DEFAULT NULL,
  `downward_notch` int NULL DEFAULT NULL,
  `accelerate_decline` int NULL DEFAULT NULL,
  `palling_up` int NULL DEFAULT NULL,
  `palling_down` int NULL DEFAULT NULL,
  `low_opened_5` int NULL DEFAULT NULL,
  `high_opened_5` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 19444007 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `profit_ability`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `code`(`code`, `report_date`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '盈利能力' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31094 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '股票代码和名称' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `share`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `security_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `security_name_abbr` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  ...
  `impl_plan_profile` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '股票分红' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ten_fixed_holder`  (
  ...
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `secucode` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `hold_num_change` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '增减(股)',
  `shares_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股份类型',
  `holder_rank` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '名次',
  `holder_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股东性质',
  `end_date` datetime(0) NULL DEFAULT NULL COMMENT '报告时间',
  `holder_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股东名称',
  `security_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `change_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '变动比例',
  `hold_num` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '持股数(股)',
  `hold_num_ratio` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '占总流通股本持股比例',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '数据创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '数据更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `ten_flow_holder`  (
  ...
  `hold_num_change` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '增减(股)',
  `shares_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股份类型',
  `holder_rank` int NULL DEFAULT NULL COMMENT '名次',
  `holder_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股东性质',
  `report_date` date NULL DEFAULT NULL COMMENT '报告时间',
  `holder_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股东名称',
  `change_ratio` decimal(16, 2) NULL DEFAULT NULL COMMENT '变动比例',
  `hold_num` bigint NULL DEFAULT NULL COMMENT '持股数(股)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 16237049 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '十大流动股东' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tran_detail`  (
  ...
  `changed_hands` bigint NULL DEFAULT NULL COMMENT '成交量（手）',
  `changed_price` double(10, 0) NULL DEFAULT NULL COMMENT '成交额（元）',
  `nature` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '性质',
  UNIQUE INDEX `bb`(`code`, `report_date`, `tran_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for tran_detail_tx
-- ----------------------------
DROP TABLE IF EXISTS `tran_detail_tx`;
CREATE TABLE `tran_detail_tx`  (
  `code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '股票代码',
  `report_date` date NULL DEFAULT NULL COMMENT '报告时间（天）',
  `tran_time` time(0) NULL DEFAULT NULL COMMENT '交易时间（时分秒）',
  `price` double(10, 2) NULL DEFAULT NULL COMMENT '成交价',
...
CREATE TABLE `transaction`  (
  ...
  `data_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '数据类型，101 天，5分钟，15分钟，30分钟，60分钟',
  `reinstatement` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '0复权   1表示前复权  2 后复权',
  `plate_count` int NULL DEFAULT NULL COMMENT '全部异动次数',
  `plate_up_count` int NULL DEFAULT NULL COMMENT '上涨异动次数',
  `t3` double(32, 2) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique`(`report_date`, `reinstatement`, `data_type`, `code`) USING BTREE,
  INDEX `code`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 211941142 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '历史交易数据' ROW_FORMAT = DYNAMIC;
