...
MODE_WEIGHTS_PATH_PREFIX = '../mode/lstm/priceMode/'
MODE_WEIGHTS_PATH_SUFFIX = '/weights'


class PriceMode(LstmMode):
...
if __name__ == '__main__':
    for one in CONFIG:
        ...
        x_train, y_train, x_test, y_test = PriceData().out_data(REDIS_SCAN_MATCH_KEY, time_steps, TEST_RECORDS, future_days)
        PriceMode().train_mode(x_train, y_train, x_test, y_test, time_steps, future_days, BATCH_SIZE, EPOCHS, MODE_WEIGHTS_PATH_PREFIX)
